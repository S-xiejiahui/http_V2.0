...
void get_local_ip_addr(char *local_ipaddr, int length)
{
    ...
    char *cmd = "ifconfig | grep -E -o '(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)' | grep -v 255 | grep -v 127.0.0.1 | grep -v 192.168.99";
